...
- Microsoft Visual Studio (available [here](https://www.visualstudio.com/vs/community/)) or the Visual C++ Build Tools (available [here](https://visualstudio.microsoft.com/visual-cpp-build-tools/)).
  ...
  - Install the latest `Windows SDK for Desktop` component.

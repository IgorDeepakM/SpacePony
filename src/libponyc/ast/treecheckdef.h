...
RULE(prefix,
  ...
  TK_OFFSETOF, TK_SIZEOF, TK_ALIGNOF);
...
GROUP(type,
  ...
  type_param_ref, type_alias_ref, dontcare_type, fun_type, error_type, infer_type,
  lambda_type, barelambda_type, literal_type, opliteral_type, control_type, entity_type);

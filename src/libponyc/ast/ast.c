...
ast_t* ast_from_string_w_question(ast_t* ast, const char* name, bool question, strtable_t* strtab)
{
  ast_t* name_node = ast_from_string(ast, name, strtab);

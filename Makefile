...
.DEFAULT_GOAL := build
.PHONY: all libs cleanlibs configure cross-configure build test test-ci test-check-version test-core test-stdlib-debug test-stdlib-release test-examples test-stress test-validate-grammar clean test-pony-lsp pony-lint test-pony-lint lint-pony-lint pony-doc test-pony-doc test-pony-compiler
...
test-ci: all test-check-version test-core test-stdlib-debug test-stdlib-release test-examples test-pony-compiler test-pony-lsp test-pony-lint test-pony-doc # test-validate-grammar disabled until further notice

...
test-ci: all test-check-version test-core test-stdlib-debug test-stdlib-release test-examples test-pony-lsp test-pony-lint # test-validate-grammar disabled until further notice
